...
module load_save_gb
    ...
    import ..sim_data_gb: sim_parameters, observable_number_of_saves, observable_data
    ...
    function save_all(parameters::sim_parameters,observable_saves::observable_number_of_saves,observable_array::observable_data)#::Nothing
        println("saving observables")
        println("occupation vector")
        ...
        if observable_saves.angle_change>0
            ...
            JLD2.save("energy.jld2","energy",observable_array.energy)
        ...
        println("saving simulation parameters")
